import{c,j as e,H as p,L as r,r as h,b as i}from"./app-Bc5zk5HS.js";import{M as m,B as o}from"./MainLayout-CLDiFmOU.js";/* empty css            */import"./createLucideIcon-BynEmhEK.js";function j({starterKits:s}){const{auth:t}=c().props;return e.jsxs(m,{children:[e.jsx(p,{title:"Starter Kits"}),e.jsxs("div",{className:"mx-auto max-w-6xl px-6 py-16",children:[e.jsxs("div",{className:"mb-16 flex items-start justify-between",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"mb-4 text-4xl font-bold tracking-tight",children:"Getting Started"}),e.jsx("p",{className:"max-w-2xl text-lg text-slate-600",children:"A collection of clean, development-ready starter kits for modern full-stack web development."})]}),t.user&&e.jsxs(r,{href:"/saved-kits",className:`
